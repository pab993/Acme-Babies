...
public class KindergartenService {
	...
	public Collection<Kindergarten> getKindergartenWithMoreCustomersInLessons(){
		
		Collection<Kindergarten> result;
		
		result = kindergartenRepository.kindergartenWithMoreCustomersInLessons();
		
		return result;
	}
	
public Collection<Kindergarten> getKindergartenWithLessCustomersInLessons(){
		
		Collection<Kindergarten> result;
		
		result = kindergartenRepository.kindergartenWithLessCustomersInLessons();
		
		return result;
	}
	
public Collection<Kindergarten> getRankingKindergartensCreatedLessons(){
	
	Collection<Kindergarten> result;
	
	result = kindergartenRepository.rankingKindergartensCreatedLessons();
