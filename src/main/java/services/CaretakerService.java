...
public class CaretakerService {
	...
	public Collection<Caretaker> getCaretakerWithMoreAssessments(){
		
		Collection<Caretaker> res;
		
		res = caretakerRepository.caretakerWithMoreAssessments();
	
	return res;
	}
	
public Collection<Object[]> getRankingCaretakersAcceptedOffers(){
		
		Collection<Object[]> res;
		
		res = caretakerRepository.rankingCaretakersAcceptedOffers();
